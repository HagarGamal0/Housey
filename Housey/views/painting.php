            ...
            foreach ($products as $value): ?>
                <div class='card mt-5 '>
                    <div class='position-relative'>
                        ...
                        <div class='btns'>
                            <?php echo "<a href= 'painting.php?add_to_cart=$value[id]'><button class='cart_btn tooltip'><span
                                        class='tooltiptext'>اضف الى السلة</span><i
                                        class='fa-solid fa-cart-plus'></i></button></a>"; ?>

                            <?php echo "<a href= 'painting.php?fav=$value[id]'> <button class='fav_btn tooltip'><span class='tooltiptext'>اضف للمفضلة</span><i
