...
$stmt = $conn->prepare("SELECT * FROM cart WHERE  user_id =1");
$stmt->execute();
...
?>
    ...
    <nav class="navbar navbar-expand-lg navbar__icons  ">
        <div class="container">
            ...
            <a href="./user_profile.php"><img src="../assets/img/profile.png" alt="" class="user_image" style="width:6%; float:left; margin-right:450px;"></a>
