...
<?php 
$stmt = $conn->prepare("SELECT * FROM fav_products WHERE user_id =1");
$stmt->execute();
$count_cart_items = count($stmt->fetchAll(PDO::FETCH_ASSOC));
// require_once("../../connection.php");
if (isset($_GET['add_to_cart'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM order_details WHERE  product_id = $get_product_id and user_id =1");
    $stmt->execute();
  ...
  if (isset($_GET['add'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM fav_products WHERE product_id = $fav_product_id and user_id =1");
    $stmt->execute();
    ...
    if ($count_fav_products>0) {
      ...
      // echo"<script>window.open('cart.php,_self')</script>";
        ...
        // die();
        $stmt = $conn->prepare("INSERT INTO fav_products(product_id, user_id) VALUES ($fav_product_id,1)");
        $stmt->execute();
...
<head>
  ...
  integrity="sha384-GLhlTQ8iRABdZLl6O3oVMWSktQOp6b7In1Zl3/Jr59b6EGGoI1aFkw7cmDA6j6gD" crossorigin="anonymous">
    <link rel="stylesheet" href="../assetss/fontawesome/css/all.css">
...
<body onload="loading()">
  ...
  <!-- end loader -->
    ...
    <nav class="navbar navbar-expand-lg navbar__icons  ">
        <div class="container">
            <a class="navbar-brand logo ms-3" href="#"><img src="../assets/imgs/Housey.svg" alt=""></a>
            ...
            <a href="../../../vendor-new/users/index.php"><img src="../assets/IMGS/[removal.ai]_tmp-63fb26bfc4317 (2).png" alt="" class="user_image" style="width:1%; float:left; margin-right:500px;"></a>
            <a href="../../../user-profile/users/index.php"><img src="../assets/IMGS/[removal.ai]_tmp-63fb26bfc4317 (2).png" alt="" class="user_image" style="width:15%; float:left; margin-right:260px;"></a>
    ...
    <nav class="navbar__links sticky-top">
        <div class="container">
            <div class="nav-bar">
                <ul class="links">
                    <li>
                        <a href="../index/index.html" class="cool-link active"></i>الرئيسية</a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <li>
                        <a href="../../../About Us/about_us.php" class="cool-link"></i>اعرف عنا</a>
                        </li>
                      </nav>
  <!-- end navbar -->
                                                <!-- SLIDER -->
  ...
  <header class="slider-container">
    <div class="left-slide">
      <div style="background-color: #8b3b05">
        <h1>قسم الكهرباء</h1>
        <p>all in pink</p>
        <a href="../Products/Electro_Products.html"><button class="btn btn-outline-success" type="submit">اعرف المزيد</button></a>
      </div>
      <div style="background-color: #d6824e">
        <h1>قسم النقاشة</h1>
        <p>with it's mountains</p>
        <a href="../Products/Painting_Products.html"><button class="btn btn-outline-success" type="submit">اعرف المزيد</button></a>
      </div>
      <div style="background-color: #d7ac58">
        <h1>قسم النجارة</h1>
        <p>in the wilderness</p>
        <a href="../Products/Carpentary_Products.html"><button class="btn btn-outline-success" type="submit">اعرف المزيد</button></a>
      </div>
      <div style="background-color: #e3b4327f">
        <h1>قسم السباكة</h1>
        <p>in the sunset</p>
        <a href="../Products/Plumbing_Products.html"><button class="btn btn-outline-success" type="submit">اعرف المزيد</button></a>
      </div>
      <div style="background-color: #da672d">
        <h1>مرحبا بكم</h1>
    ...
    <div class="right-slide">
      ...
      <div
        style="background-image: url('../assets/IMGS/Best-Website-Welcome-Message-Examples.png')">
      </div>
      <div
        style="background-image: url('../assets/IMGS/img.jpg')">
      </div>
      <div
        style="background-image: url('../assets/IMGS/Tools-Carpenter-Wood-2423826.jpg')">
      </div>
      <div
        style="background-image: url('../assets/IMGS/Paint-tools-AR20012020.jpg')">
      </div>
      <div
...
<section class="about-us">
    ...
    <div class="about-us__content col-lg-6">
      ...
      <br>
      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugit explicabo possimus delectus incidunt perferendis quaerat officia tenetur in porro, aspernatur impedit nisi cumque. Veniam, distinctio illo? Eius perferendis ipsa id fugit sed, sit nam corrupti veritatis, saepe officiis quod dolor. Magni sed modi praesentium numquam provident cum odio sequi reiciendis totam voluptatibus quas rem quam eveniet incidunt, perspiciatis maiores quis.
      </p>
    </div>
    <div class="about-us__video col-lg-5">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/8exM6VUgZFA?start=10?" title="YouTube video player" frameborder="0"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
  </div>
  </div>
  </section>
...
<?php
    ...
    <div class="feedback__rating row">
      <div class=" col-lg-4">
        ...
        <h3>Eye Liner</h3>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sed quaerat modi harum illo Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nobis aspernatur laboriosam delectus dicta itaque, at libero excepturi maxime quaerat nostrum, autem molestiae veritatis facere quam architecto, ea laborum pariatur?</p>
      ...
      <div class=" col-lg-4">
        ...
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sed quaerat modi harum illo Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur totam odit dicta! Culpa, deleniti voluptate maxime doloribus omnis in, architecto explicabo numquam illo repellat a possimus reiciendis consectetur vero!</p>
      ...
      <div class=" col-lg-4">
        ...
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sed quaerat modi harum illo Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui est exercitationem quaerat unde ipsa, explicabo itaque ratione? Magnam explicabo nisi possimus excepturi ipsam, accusamus vel, iusto maxime dicta ab nemo!</p>
...
<footer>
  ...
  <div class="footer__icons sticky-bottom">
      <p>كل جديد على قد الإيد - copyright @Group A </p>
  </div>
</footer>
</loader>
<!-- END FOOTER -->
