        ...
        <main class="container mt-5 row body ">
            ...
            <div class="col-lg-5 col-lg-5 col-lg-5 des">
                ...
                foreach ($info as $value):
                    ...
                    <div>
                        <?php echo " <a href='description.php?see_more=$value[id]'> <button class='btns btn-outline-success card_btn mt-5'><i class='fa fa-cart-plus'>اضافة الى السلة</i></button></a>"; ?>
                    </div>
                </div>
                <!-- ==========================( caruosle  )======================================== -->
