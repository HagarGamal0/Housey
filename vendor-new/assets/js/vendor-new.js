...
input.addEventListener("change", () => {
    ...
    let n = document.getElementById('inputTag').files[0];

    console.log(n)

    imageName.innerText = "لقد اخترت" + " " + n.name;
})
var z = document.getElementsByClassName('carousel-item')
...
// **************************************************************************
var editing = document.getElementById("liveToastBtn");
