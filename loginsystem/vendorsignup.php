...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submitt'])){
    $vendorRegi = $vendor->vendorRegistration($_POST);
}
						...
						<div class="form-wrapper">
							...
							<div class="form-holder select">
								<select name="field" id="" class="form-control address" required>
									<option disabled value="volvo" selected>اختر تخصصك</option>
					...
					<div class="form-end form-group">
						<div class="input-group mb-3">
							<div class>
								...
								<label id="box" for="input-group-text" class="text-white">  اوافق علي الشروط و الاحكام </label>
