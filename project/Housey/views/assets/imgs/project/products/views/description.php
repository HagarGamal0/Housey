        ...
        <main class="container mt-5 row ">
            ...
            <div class="col-lg-3 col-md-5 col-sm-5 ">
                ...
                foreach ($info as $value):
                    ?>
                    <h4 class="product_name"> اسم المنتج :
                        <?php echo $value["name"]; ?>
                    </h4>
                    <div class="rate">
                    ...
                    <div>
                        <?php echo " <a href='description.php?add_to_cart=$value[id]'> <button class='btns btn-outline-success card_btn'><i class='fa-solid fa-cart-plus'>اضافة الى السلة</i></button></a>"; ?>
                    </div>
                </div>
                <!-- ==========================( caruosle  )======================================== -->

                <div class="col-lg-1 col-md-1 col-sm-1"> </div>
                <div class="col-lg-3 mt-5 col-md-3 col-sm-4">
